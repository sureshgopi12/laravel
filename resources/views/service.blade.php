        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href='<?php echo "service";?>'>Our Services</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row" id="tabs">
          ...
          <div class="col-md-8">
            <section class='tabs-content'>
              <article id='tabs-1'>
                <img src="public/images/single_service_01.jpg" alt="">
              ...
              <article id='tabs-2'>
                <img src="public/images/single_service_02.jpg" alt="">
              ...
              <article id='tabs-3'>
                <img src="public/images/single_service_03.jpg" alt="">
              ...
              <article id='tabs-4'>
                <img src="public/images/single_service_04.jpg" alt="">
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
              <div class="partner-item">
                <img src="public/images/client-01.png" alt="">
              </div>
            </div>
          </div>
        </div>
