...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/templatemo-finance-business.css') }}">
  ...
  <body>
    ...
    <header class="">
        <nav class="navbar navbar-expand-lg">
            <div class="container">
            <a class="navbar-brand" href="http://<?php echo $_SERVER['SERVER_NAME'];?>"><h2>Finance Business</h2></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="http://<?php echo $_SERVER['SERVER_NAME'];?>">Home
                    <span class="sr-only">(current)</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href='<?php echo $_SERVER["REQUEST_URI"]."about";?>'>About Us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href='<?php echo $_SERVER["REQUEST_URI"]."service";?>'>Our Services</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="public/images/service_01.jpg" alt="">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="public/images/service_02.jpg" alt="">
              <div class="down-content">
          ...
          <div class="col-md-4">
            <div class="service-item">
              <img src="public/images/service_03.jpg" alt="">
              <div class="down-content">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="public/images/more-info.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
              ...
              <div class="partner-item">
                <img src="public/images/client-01.png" title="1" alt="1">
              </div>
              
              <div class="partner-item">
                <img src="public/images/client-01.png" title="2" alt="2">
              </div>
              
              <div class="partner-item">
                <img src="public/images/client-01.png" title="3" alt="3">
              </div>
              
              <div class="partner-item">
                <img src="public/images/client-01.png" title="4" alt="4">
              </div>
              
              <div class="partner-item">
                <img src="public/images/client-01.png" title="5" alt="5">
              </div>
